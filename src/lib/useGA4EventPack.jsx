...
const useGA4EventPack = (packName) => {
  let script = null;
  ...
  useEffect(() => {
    if (process.env.REACT_APP_ENVIRONMENT === 'cardel-product' && packName && packName != '') {
      TagManager.initialize({gtmId: 'GTM-NG8K5TRD'});
      TagManager.dataLayer({
        dataLayer: {
          event: 'custom_page_view',
          "eventName": "page_view_pack",
          "pack_name": packName
        },
      });
      // LINE
    ...
    else if (process.env.REACT_APP_ENVIRONMENT === 'cardel-develop' && packName && packName != '') {
...
export default useGA4EventPack;