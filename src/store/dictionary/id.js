...
const commonErrorEn = defaultMessages.id;

// インドネシア語
const id = {
  CARDEL: "CARDEL",
  official_site: "SITUS RESMI",
  meta_description: "'Cardel' adalah layanan permainan lotere untuk produk online TCG, termasuk 'Kartu Pokémon' dan 'Yu-Gi-Oh! kartu-kartu.' Anda dapat menikmati TCG dengan permainan lotere online dengan efek.",

  gacha: "gacha",
  Carefully_selected_original_pack: "Paket asli yang dipilih dengan cermat",
  Layout_test: "Layout test",
  Bonus_oripa: "Bonusnya",
  Pick_up_items: "Ambil barang",

  top: "HALAMAN ATAS",
  operating_company: "Perusahaan operasi",
  terms_of_Use: "Syarat Penggunaan",
  privacy_policy: "Kebijakan pribadi",
  Specified_Commercial_Transaction_Act: "UU Transaksi Komersial Tertentu",
  Customer_Service: "Pelayanan pelanggan",
  information: "informasi",
  card_number: "{ number }kartu",
  draw_n_card: "ambil { number }",
  draw_all_card: "menggambar semua",
  pay: "membayar",
  Guaranteed_last_prize: "Jaminan hadiah terakhir",
  ceiling: "bonus plafon",
  select: "Pilih",
  Unable_to_ship: 'Tidak dapat mengirim',
  Waiting_for_shipping: 'Menunggu pengiriman',
  Shipping_completed: 'Pengiriman selesai',
  Shipping_processing: 'Proses selesai',
  Shipping_Address: 'Alamat pengiriman',
  Default_shipping_address: 'Alamat pengiriman bawaan',
  Edit_Shipping_address: 'Edit alamat pengiriman',
  Add_new_delivery_address: 'Tambahkan alamat pengiriman baru',
  Confirm_Shipping_Address: 'Konfirmasikan alamat pengiriman',
  skip_video: 'Lewati video',
  Hit: 'Memukul!',
  Hit_it_hard: 'Pukul keras!!!',
  Donot_miss_it: "Jangan lewatkan!",
  more_more: 'lebih banyak lagi!',
  Break_through: 'Terobosan!!',
  deadline: 'Tenggat waktu',
  shipping_method: 'Metode pengiriman',
  Card_to_be_shipped: 'Kartu yang akan dikirim',
  Ship_selected_cards: 'Kirimkan kartu yang dipilih',
  Uses_300pt: "Gunakan 300 poin",
  deposit: "menyetorkan",
  _200_points_will_be_returned_after_shipping_is_completed: "200 poin akan dikembalikan setelah pengiriman selesai",
  It_may_take_up_to_2_weeks_for_shipping_to_be_completed: "Mungkin diperlukan waktu hingga 2 minggu untuk menyelesaikan pengiriman.",
  Press_the_Confirm_button_to_confirm_the_shipping_request: "Saat Anda menekan tombol konfirmasi, permohonan pengiriman Anda akan dikonfirmasi",
  Shipping_application: 'Aplikasi pengiriman',
  Shipping_application_confirmation: 'Konfirmasi permohonan pengiriman',
  Shipping_application_completed: 'Aplikasi pengiriman selesai',
  Please_look_forward_to_your_card_arriving: "Mohon nantikan kedatangan kartu Anda",
  game_history: 'Sejarah permainan',
  Pack_opening_results: 'Hasil pembukaan paket',
  Exchange_all_points: 'Tukarkan semua poin',
  Exchange_all_cards_into_points: 'Tukarkan semua kartu menjadi poin',
  Exchange_selected_cards_into_points: "Tukarkan kartu yang dipilih menjadi poin",
  Exchange_cards_for_points: "Tukarkan kartu dengan poin",
  Collect_selected_cards: 'Kumpulkan kartu yang dipilih',
  Exchange_selected_cards: 'Tukarkan Kartu Pilihan',
  Confirmation_of_point_redemption: 'Konfirmasi penukaran poin',
  Point_redemption_completed: 'Penukaran poin selesai',
  Confirmation_of_collection: 'Konfirmasi pengumpulan',
  Store_selected_cards_in_collection: 'Simpan kartu yang dipilih dalam koleksi',
  Cards_that_are_not_selected_will_be_automatically_converted_into_points: '*Kartu yang tidak dipilih akan otomatis dikonversi menjadi poin.',
  Cards_that_have_been_converted_into_points_cannot_be_returned: '*Kartu yang sudah dikonversi menjadi poin tidak dapat dikembalikan.',
  Cards_stored_in_the_collection____: '*Kartu yang disimpan dalam koleksi akan otomatis dikonversi menjadi poin setelah batas waktu permintaan pengiriman (3 minggu) terlewati.',
  Collection_completed: 'Pengumpulan selesai',
  Collection_List: 'Daftar Koleksi',
  Gift_Box: 'Kotak hadiah',
  receive_gift: 'menerima',
  Successfully_received_the_gift: "Berhasil menerima hadiahnya",
  Coupon: 'Kupon',
  Coupon_code: 'Kode Kupon',
  use_coupon: 'gunakan kupon',
  enter_coupon: 'masukkan kupon',
  please_enter_your_coupon: "Masukkan kode kupon",
  Coupon_code_is_invalid: 'Kode kupon tidak valid',
  Coupon_used_successfully: "Kupon berhasil digunakan",
  login: "Login",
  sign_up: "MENDAFTAR",
  ...
  close: "Menutup",
  Back: 'Kembali',
  error: "kesalahan { text }",
  credit_card: 'kartu kredit',
  Confirmation_of_consumption_points: "Konfirmasi poin konsumsi",
  Confirm_payment_method: 'Konfirmasikan metode pembayaran',
  Thank_you_for_signing_up: "Terima kasih telah mendaftar",
  Enjoy_cardel: "Nikmati 'cardel'!",
  Purchase_points: "Poin pembelian",
  Points_to_purchase: "Poin untuk dibeli",
  Payment_method: 'Cara Pembayaran',
  Please_select_from_the_buttons_at_the_bottom: "Silakan Pilih dari tombol di bagian bawah",
  insufficient_points: "poin tidak mencukupi",
  Password: "Kata sandi",
  Current_Password: 'kata sandi saat ini',
  New_Password: 'kata sandi baru',
  Reset_password: "Reset kata sandi",
  Country_of_residence: 'Konfirmasikan alamat pengiriman',
  Country_of_residence_registration: 'Pendaftaran negara tempat tinggal',
  Confirm_email_address: "Konfirmasi alamat email",
  Change_email_address: "mengganti alamat email",
  email_address: "alamat email",
  Email_sent_success: "Email berhasil dikirim",
  Registered_email_address: "Alamat email terdaftar",
  New_email_address: 'Alamat email baru',
  Send_the_authentication_URL_your_new_email_address: 'Kirim URL verifikasi ke alamat email baru Anda',
  Send_to_registered_email_address: 'Petunjuk untuk melakukan reset akan dikirimkan ke alamat email yang terdaftar',
  ...
  please_enter_your_confirmation_password: "Silakan masukkan kata sandi konfirmasi Anda",
  password_and_confirmation_password_do_not_match: "Silakan masukkan kata sandi konfirmasi Anda",
  authentication_failed_Please_try_again: "otentikasi gagal. Silakan coba lagi",
  login_failed_Please_try_again: "Gagal masuk. Coba lagi di tempat dengan jaringan terbaik Anda",
  ...
  Password_change_completed: 'Perubahan kata sandi selesai',
  For_checking: "Untuk mengecek",
  There_is_an_error_in_the_confirmation_email_address: "Ada kesalahan pada alamat email konfirmasi",

  This_email_address_is_in_use: "Alamat email ini sedang digunakan",
  I_will_register_as_a_member_after_agreeing_to_the_terms_of_use_and_privacy_policy_of_this_service: "Saya akan mendaftar sebagai anggota setelah menyetujui syarat penggunaan dan kebijakan privasi layanan ini",
  Password_format_error: "Kata sandi harus terdiri dari 6 hingga 32 karakter alfanumerik dan simbol dengan lebar setengah",
  Your_email_address_has_been_confirmed: "Alamat email Anda telah dikonfirmasi",
  A_confirmation_email_has_been_sent_to_your_email_address: "Email konfirmasi telah dikirim ke alamat email Anda",
  Please_click_on_the_URL_in_the_email_body_to_proceed_to_main_registration: "Silakan klik URL di badan email untuk melanjutkan ke pendaftaran utama.",
  Instructions_to_reset_your_password_have_been_sent_to_your_email_address: "Petunjuk untuk mereset kata sandi Anda telah dikirimkan ke alamat email Anda.",
  If_you_do_not_receive_the_verification_email: "Jika Anda tidak menerima email verifikasi",
  If_you_do_not_receive_the_information_email: "Jika Anda tidak menerima email informasi",
  There_may_be_an_error_in_your_email_address__Please_register_again_with_the_correct_email_address: "Mungkin ada kesalahan pada alamat email Anda. Silakan mendaftar kembali dengan alamat email yang benar.",
  The_verification_email_may_arrive_in_your_spam_folder_Please_check_your_spam_folder: "Email verifikasi mungkin telah diterima di folder spam Anda. Silakan periksa folder spam Anda.",
  Please_set_your_settings_so_that_you_can_receive_emails_from: "Harap aktifkan penerimaan email dari { email }.",
  Notes_on_regional_registration: "Anda tidak dapat mengubah negara tempat tinggal Anda. Jika Anda salah mendaftarkan negara tempat tinggal Anda, silakan hubungi dukungan pelanggan.",
  This_product_is_sold_out: 'Produk ini sudah habis terjual',
  Players_are_flooding_in_Please_try_again: 'Pemain berdatangan. Silakan coba lagi',
  A_system_error_has_occurred__Please_try_again: "Terjadi kesalahan sistem. Silakan coba lagi",
  Opening_in: 'Membuka',
  day: 'Hari',
  hour: 'Jam',
  minutes: 'Menit',
  seconds: 'Detik',
  will_be_released: 'Akan dirilis',
  account_cannnot_be_used_to_purchase: 'Akun ini tidak dapat digunakan untuk membeli',

  hello: "Hello, wang!",
  hello_name: "Hello, { my_name } !",

  gacha_action_error_code_102: "Produk ini tidak dapat dibeli",
  gacha_action_error_code_202: "Terlalu banyak koneksi, silakan coba lagi",
  gacha_action_error_code_203: "Produk ini tidak dapat dibeli",
  gacha_action_error_code_204: "Terlalu banyak koneksi, silakan coba lagi",
  gacha_action_error_code_205: "Produk ini tidak dapat dibeli",
  gacha_action_error_code_206: "Produk ini tidak dapat dibeli",
  gacha_action_error_code_207: "Produk ini tidak dapat dibeli",
  gacha_action_error_code_208: "Produk ini tidak dapat dibeli",
  gacha_action_error_code_301: "Produk ini tidak dapat dibeli",
  gacha_action_error_code_302: "Produk ini tidak dapat dibeli",
  gacha_action_error_code_303: "Produk ini tidak dapat dibeli",
  gacha_action_error_code_null: "Terlalu banyak koneksi, silakan coba lagi",

  Please_enter_your_shipping_name: "Silakan masukkan nama penerima paket.",
  Please_enter_your_shipping_zipcode: "Silakan masukkan kode pos tujuan paket.",
  Please_enter_your_shipping_address: "Silakan masukkan alamat pengiriman",
  Please_enter_your_shipping_tel: "Silakan masukkan nomor telepon alamat pengiriman",


  Gift_nema: 'Nama hadiah',
  bonus_oripa: "produk bonus",
  logout: "keluar",
  pre_opening: "pra pembukaan",
  userShippingName: "Nama penerima paket",
  userShippingZipcode: "Kode pos pengiriman",
  userShippingAddress: "Alamat pengiriman",
  userShippingTel: "Nomor telepon pengiriman",
  userDefault: "Tetapkan tujuan ini sebagai default",
  faq: 'FAQ',
  Everyones_posts: 'Postingan semua orang',
  unable_shipping_item_exists: 'tidak dapat mengirimkan barang yang ada',
  Video_playback_failure: 'Kegagalan pemutaran video',
  This_winning_result_has_been_added_to_your_collection: "Hasil kemenangan ini telah ditambahkan ke koleksi Anda",
  Please_play_in_a_place_with_good_communication_environment: "Silakan bermain di tempat dengan lingkungan komunikasi yang baik",
  If_you_close_your_browser_and_access_it_again_you_will_be_less_likely_to_experience_playback_failures: "Jika Anda menutup browser dan mengaksesnya kembali, kecil kemungkinan Anda akan mengalami kegagalan pemutaran",
  Invite_your_friends_and_get_great_benefits: "Undang teman Anda dan dapatkan manfaat besar",
  Your_friend_will_become_a_member_of_Cardel_using_the_referral_code_and_benefits_will_be_delivered_to_each_others_gift_box_after_SMS_authentication_is_completed: "Your friend will become a member of Cardel using the referral code and benefits will be delivered to each others gift box after Otentikasi SMS is completed",
  Introduction_URL_if_you_cannot_use_QR_code: "URL perkenalan jika Anda tidak dapat menggunakan kode QR",
  When_entering_the_invitation_code_directly_please_use_the_numbers_below: "Saat memasukkan kode undangan secara langsung silakan gunakan nomor di bawah ini",
  invitation_code: "kode undangan",
  Please_enter_your_invitation_code: "Silakan masukkan kode undangan Anda",
  Only_if_you_have: "Silakan masukkan kode undangan Anda",
  SMS_authentication: "Otentikasi SMS",
  SMS_authenticated: "SMS diautentikasi",
  Please_enter_a_phone_number_that_can_receive_SMS: "Silakan masukkan nomor telepon yang dapat menerima SMS",
  Only_phone_numbers_in_your_area_of_residence_can_be_used_for_SMS_verification: 'Hanya nomor telepon di wilayah tempat tinggal Anda yang dapat digunakan untuk verifikasi SMS',
  SMS_authentication_cannot_be_performed_multiple_times_with_the_same_phone_number: 'Otentikasi SMS tidak dapat dilakukan berkali-kali dengan nomor telepon yang sama',
  The_verification_code_will_arrive_within_5_minutes: "Kode verifikasi akan tiba dalam waktu 5 menit",
  Send_SMS: "Kirim SMS",
  Send_SMS_again: "Kirim SMS",
  Please_enter_your_phone_number: "Masukkan nomor telepon anda",
  Please_check_your_phone_number: "Silakan periksa nomor telepon Anda",
  SMS_sent_completed: "SMS terkirim selesai",
  authentication_code: "SMS terkirim selesai",
  Please_enter_the_verification_code_received_via_SMS: "Silakan masukkan kode verifikasi yang diterima melalui SMS",
  If_you_do_not_receive_the_verification_code_via_SMS__please_send_it_again: "Jika Anda tidak menerima kode verifikasi melalui SMS. tolong kirimkan lagi",
  Send_verification_code: "Kirim kode verifikasi",
  antique: 'Tampilan berdasarkan Hukum Bisnis Barang Bekas',
  address_level1: "prefektur",
  address_level2: "Kota/kelurahan/kota/desa",
  address_line1: "Nama kota/nomor blok",
  address_line2: "Nama bangunan/nama bangunan, dll.",
  ...
  required: "diperlukan",
  currently_busy: "sedang sibuk",
  MultipleAccountCreationError: "Kesalahan pembuatan beberapa akun",
  Log_in_with_an_already_created_account: 'Masuk dengan akun yang sudah dibuat',
  Please_wait_a_while_and_try_again: 'Harap tunggu beberapa saat dan coba lagi',
  If_you_have_trouble_creating_an_account__please_contact_support: 'Jika Anda kesulitan membuat akun. silakan hubungi dukungan',
  Thank_you_for_your_cooperation_in_maintaining_fairness: "Terima kasih atas kerja sama Anda dalam menjaga keadilan.",
  Last_creation_date_and_time: 'Tanggal dan waktu pembuatan terakhir',
  This_creation_date_and_time: 'Tanggal dan waktu pembuatan ini',
  MultipleEnterCouponCodeError: 'Deteksi penipuan kupon',
  If_you_have_trouble_using_coupons__please_contact_support: 'Jika Anda kesulitan menggunakan kupon. silakan hubungi dukungan',
  Under_maintenance: 'Dalam perbaikan',
  Currently_undergoing_maintenance: 'Saat ini sedang menjalani pemeliharaan',
  No_maintenance_scheduled_at_this_time: 'Tidak ada pemeliharaan yang dijadwalkan saat ini',
  Scheduled_start_date_and_time: 'Tanggal dan waktu mulai yang dijadwalkan',
  Scheduled_end_date_and_time: 'Tanggal dan waktu akhir yang dijadwalkan',
  Version_update_contents: 'Konten pembaruan versi',
  BillingLock: 'Penagihan dibatasi',
  Unable_to_purchase_product: 'Tidak dapat membeli produk',
  If_you_have_trouble_purchasing_a_product__please_contact_support: 'Jika Anda kesulitan membeli suatu produk. silakan hubungi dukungan',
  this_phone_number_is_not_available: "Nomor telepon ini tidak tersedia",
  Please_check_your_sms_token: "Silakan periksa token sms Anda",
  Depending_on_the_delivery_situation__it_may_take_several_days_from_shipping_to_delivery: 'Tergantung pada situasi pengiriman. mungkin diperlukan waktu beberapa hari dari pengiriman hingga pengiriman',
