...
const commonErrorEn = defaultMessages.pt;

// ポルトガル語
const pt = {
  CARDEL: "CARDEL",
  official_site: "SITE OFICIAL",
  meta_description: "'Cardel' é um serviço de jogos de loteria para produtos online do TCG, incluindo 'cartas Pokémon' e 'Yu-Gi-Oh! cartas.' Você pode desfrutar do TCG com um jogo de loteria online com efeitos.",

  gacha: "gacha",
  Carefully_selected_original_pack: "Pacote original cuidadosamente selecionado",
  Layout_test: "Layout test",
  Bonus_oripa: "Bônus",
  Pick_up_items: "Pegue itens",

  top: "PÁGINA PRINCIPAL",
  operating_company: "Companhia em operação",
  terms_of_Use: "Termos de uso",
  privacy_policy: "política de Privacidade",
  Specified_Commercial_Transaction_Act: "Lei de transação comercial especificada",
  Customer_Service: "Atendimento ao Cliente",
  information: "Informação",
  card_number: "{ number }cartão",
  draw_n_card: "sorteio { number }",
  draw_all_card: "tirar todas as cartas",
  pay: "pagar",
  Guaranteed_last_prize: "Último prêmio garantido",
  ceiling: "bônus de teto",
  select: "selecione",
  Unable_to_ship: 'Não é possível enviar',
  Waiting_for_shipping: 'Aguardando envio',
  Shipping_completed: 'Envio concluído',
  Shipping_processing: 'Processo concluído',
  Shipping_Address: 'Endereço para envio',
  Default_shipping_address: 'endereço de entrega padrão',
  Edit_Shipping_address: 'Editar endereço de entrega',
  Add_new_delivery_address: 'Adicionar novo endereço de entrega',
  Confirm_Shipping_Address: 'Confirme o endereço de entrega',
  skip_video: 'Pular vídeo',
  Hit: 'Bata!',
  Hit_it_hard: 'Bata forte!!!',
  Donot_miss_it: "Não perca!",
  more_more: 'mais mais!',
  Break_through: 'Avanço!!',
  deadline: 'Prazo final',
  shipping_method: 'Método de envio',
  Card_to_be_shipped: 'Cartão a ser enviado',
  Ship_selected_cards: 'Enviar cartões selecionados',
  Uses_300pt: "Use 300 pontos",
  deposit: "depósito",
  _200_points_will_be_returned_after_shipping_is_completed: "200 pontos serão devolvidos após a conclusão do envio",
  It_may_take_up_to_2_weeks_for_shipping_to_be_completed: "Pode levar até 2 semanas para que o envio seja concluído.",
  Press_the_Confirm_button_to_confirm_the_shipping_request: "Ao pressionar o botão confirmar, seu pedido de envio será confirmado",
  Shipping_application: 'Aplicativo de envio',
  Shipping_application_confirmation: 'Confirmação do pedido de envio',
  Shipping_application_completed: 'Solicitação de envio concluída',
  Please_look_forward_to_your_card_arriving: "Aguarde a chegada do seu cartão",
  game_history: 'História do jogo',
  Pack_opening_results: 'Resultados de abertura de pacote',
  Exchange_all_points: 'Troque todos os pontos',
  Exchange_all_cards_into_points: 'Troque todas as cartas por pontos',
  Exchange_selected_cards_into_points: "Troque cartas selecionadas por pontos",
  Exchange_cards_for_points: "Troque cartões por pontos",
  Collect_selected_cards: 'Colete cartas selecionadas',
  Exchange_selected_cards: 'Trocar cartões selecionados',
  Confirmation_of_point_redemption: 'Confirmação de resgate de pontos',
  Point_redemption_completed: 'Resgate de pontos concluído',
  Confirmation_of_collection: 'Confirmação de coleta',
  Store_selected_cards_in_collection: 'Armazene os cartões selecionados na coleção',
  Cards_that_are_not_selected_will_be_automatically_converted_into_points: '*Os cartões que não forem selecionados serão automaticamente convertidos em pontos.',
  Cards_that_have_been_converted_into_points_cannot_be_returned: '*Cartões convertidos em pontos não poderão ser devolvidos.',
  Cards_stored_in_the_collection____: '*Os cartões armazenados na coleção serão convertidos automaticamente em pontos após o término do prazo de solicitação de envio (3 semanas).',
  Collection_completed: 'Coleta concluída',
  Collection_List: 'Lista de coleções',
  Gift_Box: 'Caixa de presente',
  receive_gift: 'receber',
  Successfully_received_the_gift: "Recebeu o presente com sucesso",
  Coupon: 'Cupom',
  Coupon_code: 'Código do cupom',
  use_coupon: 'usar cupom',
  enter_coupon: 'insira o cupom',
  please_enter_your_coupon: "Por favor insira o código do cupom",
  Coupon_code_is_invalid: 'O código do cupom é inválido',
  Coupon_used_successfully: "Cupom usado com sucesso",
  login: "assinar em",
  ...
  Confirmation_of_consumption_points: "Confirmação de pontos de consumo",
  Confirm_payment_method: 'Confirme a forma de pagamento',
  Thank_you_for_signing_up: "Obrigado por inscrever-se",
  Enjoy_cardel: "Aproveite 'cardel'",
  Purchase_points: "Comprar pontos",
  Points_to_purchase: "Pontos para comprar",
  Payment_method: 'Forma de pagamento',
  Please_select_from_the_buttons_at_the_bottom: "Selecione um dos botões na parte inferior",
  insufficient_points: "pontos insuficientes",
  Password: "Senha",
  Current_Password: 'Senha atual',
  New_Password: 'Nova Senha',
  Reset_password: "Redefinir senha",
  Country_of_residence: 'Confirme o endereço de entrega',
  Country_of_residence_registration: 'Registro do país de residência',
  Confirm_email_address: "Confirme o endereço de e-mail",
  Change_email_address: "Mude o endereço de email",
  ...
  Send_the_authentication_URL_your_new_email_address: 'Envie o URL de verificação para seu novo endereço de e-mail',
  Send_to_registered_email_address: 'As instruções para redefinir sua senha serão enviadas para o seu endereço de e-mail cadastrado.',
  ...
  please_enter_your_confirmation_password: "Por favor insira sua senha de confirmação",
  password_and_confirmation_password_do_not_match: "Por favor insira sua senha de confirmação",
  authentication_failed_Please_try_again: "a autenticação falhou. Por favor, tente novamente",
  login_failed_Please_try_again: "Falha no login. Tente novamente onde sua rede for melhor",
  new_registration_failed: "New registration failed.",

  Forgot_password: "Esqueceu sua senha?",
  Change_Password: 'Alterar a senha',
  Set_new_password: 'Definir nova senha',
  Password_change_completed: 'Alteração de senha concluída',
  For_checking: "Para verificar",
  There_is_an_error_in_the_confirmation_email_address: "Há um erro no endereço de e-mail de confirmação",
  This_email_address_is_in_use: "Esse endereço de email está em uso",
  I_will_register_as_a_member_after_agreeing_to_the_terms_of_use_and_privacy_policy_of_this_service: "Vou me registrar como membro após concordar com os termos de uso e política de privacidade deste serviço",
  Password_format_error: "A senha deve ter entre 6 e 32 caracteres alfanuméricos e símbolos de meia largura",
  Your_email_address_has_been_confirmed: "Seu endereço de e-mail foi confirmado",
  A_confirmation_email_has_been_sent_to_your_email_address: "Um e-mail de confirmação foi enviado para o seu endereço de e-mail",
  Please_click_on_the_URL_in_the_email_body_to_proceed_to_main_registration: "Clique no URL no corpo do e-mail para prosseguir para o registro principal.",
  Instructions_to_reset_your_password_have_been_sent_to_your_email_address: "As instruções para redefinir sua senha foram enviadas para seu endereço de e-mail.",
  If_you_do_not_receive_the_verification_email: "Se você não receber o e-mail de verificação",
  If_you_do_not_receive_the_information_email: "Se você não receber o e-mail de informações",
  There_may_be_an_error_in_your_email_address__Please_register_again_with_the_correct_email_address: "Pode haver um erro no seu endereço de e-mail. Por favor, registre-se novamente com o endereço de e-mail correto.",
  The_verification_email_may_arrive_in_your_spam_folder_Please_check_your_spam_folder: "O e-mail de verificação pode ter sido recebido na sua pasta de spam. Por favor, verifique sua pasta de spam.",
  Please_set_your_settings_so_that_you_can_receive_emails_from: "Ative o recebimento de e-mails de { email }.",
  Notes_on_regional_registration: "Você não pode alterar seu país de residência. Se você registrou seu país de residência incorretamente, entre em contato com o suporte ao cliente.",
  This_product_is_sold_out: 'Este produto está esgotado',
  Players_are_flooding_in_Please_try_again: 'Os jogadores estão chegando. Tente novamente',
  A_system_error_has_occurred__Please_try_again: "Ocorreu um erro no sistema. Por favor, tente novamente",
  Opening_in: 'Abrindo em',
  day: 'Dia',
  hour: 'Horas',
  minutes: 'Minutos',
  seconds: 'segundos',
  will_be_released: 'Será libertado',
  account_cannnot_be_used_to_purchase: 'Esta conta não pode ser usada para comprar',

  hello: "Hello, wang!",
  hello_name: "Hello, { my_name } !",

  gacha_action_error_code_102: "Este produto não pode ser comprado",
  gacha_action_error_code_202: "Muitas conexões, tente novamente",
  gacha_action_error_code_203: "Este produto não pode ser comprado",
  gacha_action_error_code_204: "Muitas conexões, tente novamente",
  gacha_action_error_code_205: "Este produto não pode ser comprado",
  gacha_action_error_code_206: "Este produto não pode ser comprado",
  gacha_action_error_code_207: "Este produto não pode ser comprado",
  gacha_action_error_code_208: "Este produto não pode ser comprado",
  gacha_action_error_code_301: "Este produto não pode ser comprado",
  gacha_action_error_code_302: "Este produto não pode ser comprado",
  gacha_action_error_code_303: "Este produto não pode ser comprado",
  gacha_action_error_code_null: "Muitas conexões, tente novamente",

  Please_enter_your_shipping_name: "Por favor, insira o nome do destinatário do pacote.",
  Please_enter_your_shipping_zipcode: "Por favor, insira o código postal do destino do pacote.",
  Please_enter_your_shipping_address: "Por favor insira o endereço de entrega",
  Please_enter_your_shipping_tel: "Por favor insira o número de telefone do endereço de entrega",

  Gift_nema: 'Nome do presente',
  bonus_oripa: "produtos bônus",
  logout: "odjaviti se",
  pre_opening: "pré abertura",

  userShippingName: "Nome do destinatário do pacote",
  userShippingZipcode: "Código postal de entrega",
  userShippingAddress: "Endereço de entrega",
  userShippingTel: "Número de telefone de entrega",
  userDefault: "Defina este destino como padrão",
  faq: 'FAQ',
  Everyones_posts: 'Postagens de todos',
  unable_shipping_item_exists: 'existe um item que não pode ser enviado',
  Video_playback_failure: 'Falha na reprodução de vídeo',
  This_winning_result_has_been_added_to_your_collection: "Este resultado vencedor foi adicionado à sua coleção",
  Please_play_in_a_place_with_good_communication_environment: "Por favor, jogue em um local com bom ambiente de comunicação",
  If_you_close_your_browser_and_access_it_again_you_will_be_less_likely_to_experience_playback_failures: "Se você fechar seu navegador e acessá-lo novamente, será menos provável que ocorram falhas na reprodução",
  Invite_your_friends_and_get_great_benefits: "Convide seus amigos e obtenha ótimos benefícios",
  Your_friend_will_become_a_member_of_Cardel_using_the_referral_code_and_benefits_will_be_delivered_to_each_others_gift_box_after_SMS_authentication_is_completed: "Seu amigo se tornará membro da Cardel usando o código de referência e os benefícios serão entregues na caixa de presente um do outro após a autenticação por SMS ser concluída",
  Introduction_URL_if_you_cannot_use_QR_code: "URL de introdução se você não puder usar o código QR",
  When_entering_the_invitation_code_directly_please_use_the_numbers_below: "Ao inserir o código de convite diretamente, use os números abaixo",
  invitation_code: "Código de Convite",
  Please_enter_your_invitation_code: "Por favor insira seu código de convite",
  Only_if_you_have: "Por favor insira seu código de convite",
  SMS_authentication: "Autenticação SMS",
  SMS_authenticated: "SMS autenticado",
  Please_enter_a_phone_number_that_can_receive_SMS: "Insira um número de telefone que possa receber SMS",
  Only_phone_numbers_in_your_area_of_residence_can_be_used_for_SMS_verification: 'Apenas números de telefone na sua área de residência podem ser usados para verificação por SMS',
  SMS_authentication_cannot_be_performed_multiple_times_with_the_same_phone_number: 'A autenticação por SMS não pode ser realizada várias vezes com o mesmo número de telefone',
  The_verification_code_will_arrive_within_5_minutes: "O código de verificação chegará em 5 minutos",
  Send_SMS: "Enviar SMS",
  Send_SMS_again: "Enviar SMS",
  Please_enter_your_phone_number: "Por favor, digite seu número de telefone",
  Please_check_your_phone_number: "Verifique seu número de telefone",
  SMS_sent_completed: "SMS enviado concluído",
  authentication_code: "SMS enviado concluído",
  Please_enter_the_verification_code_received_via_SMS: "Por favor insira o código de verificação recebido via SMS",
  If_you_do_not_receive_the_verification_code_via_SMS__please_send_it_again: "Se você não receber o código de verificação via SMS. por favor envie novamente",
  Send_verification_code: "Enviar código de verificação",
  antique: 'Exibição com base na Lei Comercial de Bens de Segunda Mão',
  address_level1: "prefeituras",
  address_level2: "Cidade/bairro/vila/vila",
  address_line1: "Nome da cidade/número do quarteirão",
  address_line2: "Nome do edifício/nome do edifício, etc.",
  ...
  currently_busy: "Atualmente ocupado",
  MultipleAccountCreationError: "Erro ao criar várias contas",
  Log_in_with_an_already_created_account: 'Faça login com uma conta já criada',
  Please_wait_a_while_and_try_again: 'Aguarde um pouco e tente novamente',
  If_you_have_trouble_creating_an_account__please_contact_support: 'Se você tiver problemas para criar uma conta. entre em contato com o suporte',
  Thank_you_for_your_cooperation_in_maintaining_fairness: "Obrigado pela sua cooperação na manutenção da justiça.",
  Last_creation_date_and_time: 'Data e hora da última criação',
  This_creation_date_and_time: 'Esta data e hora de criação',
  MultipleEnterCouponCodeError: 'Detecção de fraude de cupom',
  If_you_have_trouble_using_coupons__please_contact_support: 'Se você tiver problemas para usar cupons. entre em contato com o suporte',
  Under_maintenance: 'Em manutenção',
  Currently_undergoing_maintenance: 'Atualmente em manutenção',
  No_maintenance_scheduled_at_this_time: 'Nenhuma manutenção programada neste momento',
  Scheduled_start_date_and_time: 'Data e hora de início agendada',
  Scheduled_end_date_and_time: 'Data e hora de término programada',
  Version_update_contents: 'Conteúdo de atualização de versão',
  BillingLock: 'O faturamento é restrito',
  Unable_to_purchase_product: 'Não é possível comprar o produto',
  If_you_have_trouble_purchasing_a_product__please_contact_support: 'Se você tiver problemas para comprar um produto. entre em contato com o suporte',
  this_phone_number_is_not_available: "Este número de telefone não está disponível",
  Please_check_your_sms_token: "Verifique seu token de SMS",
  Depending_on_the_delivery_situation__it_may_take_several_days_from_shipping_to_delivery: 'Dependendo da situação de entrega. pode levar vários dias desde o envio até a entrega',
