...
const commonErrorEn = defaultMessages.de;
// ドイツ語
const de = {
  CARDEL: "CARDEL",
  official_site: "OFFIZIELLE WEBSITE",
  meta_description: "„Cardel“ ist ein Lotteriespieldienst für die Online-Produkte von TCG, darunter „Pokémon-Karten“ und „Yu-Gi-Oh!“. Karten.' Sie können TCG mit einem Online-Lotteriespiel mit Effekten genießen.",

  gacha: "gacha",
  Carefully_selected_original_pack: "Sorgfältig ausgewählte Originalverpackung",
  Layout_test: "Layout test",
  Bonus_oripa: "Bonus",
  Pick_up_items: "Gegenstände abholen",

  top: "OBERSTE SEITE",
  operating_company: "Betreibergesellschaft",
  terms_of_Use: "Nutzungsbedingungen",
  privacy_policy: "Datenschutzrichtlinie",
  Specified_Commercial_Transaction_Act: "Spezifiziertes Gesetz über Handelsgeschäfte",
  Customer_Service: "Kundendienst",
  information: "information",
  card_number: "{ number }Karte",
  draw_n_card: "Ziehe { number }",
  draw_all_card: "Ziehe alle Karten",
  pay: "zahlen",
  Guaranteed_last_prize: "Garantierter letzter Preis",
  ceiling: "Deckenbonus",
  select: "wählen",
  Unable_to_ship: 'Versand nicht möglich',
  Waiting_for_shipping: 'Warten auf den Versand',
  Shipping_completed: 'Versand abgeschlossen',
  Shipping_processing: 'Vorgang abgeschlossen',
  Shipping_Address: 'Lieferanschrift',
  Default_shipping_address: 'Standard Lieferadresse',
  Edit_Shipping_address: 'Lieferadresse bearbeiten',
  Add_new_delivery_address: 'Neue Lieferadresse hinzufügen',
  Confirm_Shipping_Address: 'Bestätigen Sie die Lieferadresse',
  skip_video: 'Video überspringen',
  Hit: 'Treffer!',
  Hit_it_hard: 'Schlagen Sie hart zu!!!',
  Donot_miss_it: "Verpassen Sie es nicht!",
  more_more: 'mehr mehr!',
  Break_through: 'Durchbrechen!!',
  deadline: 'Frist',
  shipping_method: 'Versandart',
  Card_to_be_shipped: 'Karte soll versendet werden',
  Ship_selected_cards: 'Ausgewählte Karten versenden',
  Uses_300pt: "Verwenden Sie 300 Punkte",
  deposit: "Kaution",
  _200_points_will_be_returned_after_shipping_is_completed: "200 Punkte werden nach Abschluss des Versands zurückerstattet",
  It_may_take_up_to_2_weeks_for_shipping_to_be_completed: "Es kann bis zu 2 Wochen dauern, bis der Versand abgeschlossen ist.",
  Press_the_Confirm_button_to_confirm_the_shipping_request: "Wenn Sie auf die Schaltfläche „Bestätigen“ klicken, wird Ihr Versandantrag bestätigt",
  Shipping_application: 'Versandanwendung',
  Shipping_application_confirmation: 'Bestätigung des Versandantrags',
  Shipping_application_completed: 'Versandantrag abgeschlossen',
  Please_look_forward_to_your_card_arriving: "Bitte freuen Sie sich auf die Ankunft Ihrer Karte",
  game_history: 'Spielgeschichte',
  Pack_opening_results: 'Ergebnisse der Packungsöffnung',
  Exchange_all_points: 'Tauschen Sie alle Punkte aus',
  Exchange_all_cards_into_points: 'Tausche alle Karten in Punkte um',
  Exchange_selected_cards_into_points: "Tauschen Sie ausgewählte Karten in Punkte ein",
  Exchange_cards_for_points: "Tauschen Sie Karten gegen Punkte",
  Collect_selected_cards: 'Sammle ausgewählte Karten',
  Exchange_selected_cards: 'Ausgewählte Karten austauschen',
  Confirmation_of_point_redemption: 'Bestätigung der Punkteeinlösung',
  Point_redemption_completed: 'Punkteeinlösung abgeschlossen',
  Confirmation_of_collection: 'Abholbestätigung',
  Store_selected_cards_in_collection: 'Speichern Sie ausgewählte Karten in der Sammlung',
  Cards_that_are_not_selected_will_be_automatically_converted_into_points: '*Nicht ausgewählte Karten werden automatisch in Punkte umgewandelt.',
  Cards_that_have_been_converted_into_points_cannot_be_returned: '*Karten, die in Punkte umgewandelt wurden, können nicht zurückgegeben werden.',
  Cards_stored_in_the_collection____: '*In der Sammlung gespeicherte Karten werden nach Ablauf der Versandanforderungsfrist (3 Wochen) automatisch in Punkte umgewandelt.',
  Collection_completed: 'Sammlung abgeschlossen',
  Collection_List: 'Sammlungsliste',
  Gift_Box: 'Geschenkbox',
  receive_gift: 'erhalten',
  Successfully_received_the_gift: "Das Geschenk wurde erfolgreich erhalten",
  Coupon: 'Coupon',
  Coupon_code: 'Gutscheincode',
  use_coupon: 'Gutschein verwenden',
  enter_coupon: 'Gutschein eingeben',
  please_enter_your_coupon: "Bitte geben Sie den Gutscheincode ein",
  Coupon_code_is_invalid: 'Der Gutscheincode ist ungültig',
  Coupon_used_successfully: "Gutschein erfolgreich eingesetzt",
  login: "Einloggen",
  sign_up: "ANMELDEN",
  ...
  Confirmation_of_consumption_points: "Bestätigung der Verbrauchsstellen",
  Confirm_payment_method: 'Bestätigen Sie die Zahlungsmethode',
  Thank_you_for_signing_up: "Vielen Dank, dass Sie sich angemeldet haben",
  Enjoy_cardel: "Genießen Sie „Cardel“!",
  Purchase_points: "Kaufpunkte",
  Points_to_purchase: "Punkte zum Kauf",
  Payment_method: 'Bezahlverfahren',
  Please_select_from_the_buttons_at_the_bottom: "Bitte wählen Sie aus den Schaltflächen unten aus",
  insufficient_points: "nicht genügend Punkte",
  Password: "Passwort",
  Current_Password: 'Aktuelles Passwort',
  New_Password: 'Neues Kennwort',
  Reset_password: "Passwort zurücksetzen",
  Country_of_residence: 'Bestätigen Sie die Lieferadresse',
  Country_of_residence_registration: 'Land der Wohnsitzregistrierung',
  ...
  Send_the_authentication_URL_your_new_email_address: 'Senden Sie die Bestätigungs-URL an Ihre neue E-Mail-Adresse',
  Send_to_registered_email_address: 'Anweisungen zum Zurücksetzen werden an die registrierte E-Mail-Adresse gesendet',
  ...
  please_enter_your_confirmation_password: "Bitte geben Sie Ihr Bestätigungspasswort ein",
  password_and_confirmation_password_do_not_match: "Bitte geben Sie Ihr Bestätigungspasswort ein",
  authentication_failed_Please_try_again: "Authentifizierung fehlgeschlagen. Bitte versuche es erneut",
  login_failed_Please_try_again: "Die Anmeldung ist fehlgeschlagen. Bitte versuchen Sie es noch einmal dort, wo Ihr Netzwerk am besten ist",
  new_registration_failed: "New registration failed.",

  Forgot_password: "Kennwort vergessen?",
  Change_Password: 'Kennwort ändern',
  Set_new_password: 'Neues Passwort festlegen',
  Password_change_completed: 'Passwortänderung abgeschlossen',
  For_checking: "Zur Kontrolle",
  There_is_an_error_in_the_confirmation_email_address: "Es liegt ein Fehler in den Bestätigungs-E-Mail-Adressen vor",
  This_email_address_is_in_use: "Diese E-Mail-Adresse wird verwendet",
  I_will_register_as_a_member_after_agreeing_to_the_terms_of_use_and_privacy_policy_of_this_service: "Ich werde mich als Mitglied registrieren, nachdem ich den Nutzungsbedingungen und Datenschutzrichtlinien dieses Dienstes zugestimmt habe",
  Password_format_error: "Das Passwort muss zwischen 6 und 32 alphanumerische Zeichen und Symbole halber Breite umfassen",
  Your_email_address_has_been_confirmed: "Deine Emailadresse wurde bestätigt",
  A_confirmation_email_has_been_sent_to_your_email_address: "Eine Bestätigungs-E-Mail wurde an Ihre E-Mail-Adresse gesendet.",
  Please_click_on_the_URL_in_the_email_body_to_proceed_to_main_registration: "Bitte klicken Sie auf die URL im E-Mail-Text, um zur Hauptregistrierung zu gelangen.",
  Instructions_to_reset_your_password_have_been_sent_to_your_email_address: "Anweisungen zum Zurücksetzen Ihres Passworts wurden an Ihre E-Mail-Adresse gesendet",
  If_you_do_not_receive_the_verification_email: "Wenn Sie die Bestätigungs-E-Mail nicht erhalten",
  If_you_do_not_receive_the_information_email: "Wenn Sie die Informations-E-Mail nicht erhalten",
  There_may_be_an_error_in_your_email_address__Please_register_again_with_the_correct_email_address: "Möglicherweise liegt ein Fehler in Ihrer E-Mail-Adresse vor. Bitte registrieren Sie sich erneut mit der korrekten E-Mail-Adresse.",
  The_verification_email_may_arrive_in_your_spam_folder_Please_check_your_spam_folder: "Die Bestätigungs-E-Mail wurde möglicherweise in Ihrem Spam-Ordner empfangen. Bitte überprüfen Sie Ihren Spam-Ordner.",
  Please_set_your_settings_so_that_you_can_receive_emails_from: "Bitte aktivieren Sie den Empfang von E-Mails von { email }.",
  Notes_on_regional_registration: "Sie können Ihr Wohnsitzland nicht ändern. Wenn Sie Ihr Wohnsitzland falsch angegeben haben, wenden Sie sich bitte an den Kundendienst.",
  This_product_is_sold_out: 'Dieses Produkt ist ausverkauft',
  Players_are_flooding_in_Please_try_again: 'Es strömen immer mehr Spieler herein. Bitte versuchen Sie es erneut',
  A_system_error_has_occurred__Please_try_again: "Es ist ein Systemfehler aufgetreten. Bitte versuche es erneut",
  Opening_in: 'Öffnung in',
  day: 'Tag',
  hour: 'Std.',
  minutes: 'Minuten',
  seconds: 'Sek',
  will_be_released: 'Wird freigegeben',
  account_cannnot_be_used_to_purchase: 'Dieses Konto kann nicht zum Kauf verwendet werden',

  hello: "Hello, wang!",
  hello_name: "Hello, { my_name } !",

  gacha_action_error_code_102: "Dieses Produkt kann nicht gekauft werden",
  gacha_action_error_code_202: "Zu viele Verbindungen, bitte versuchen Sie es erneut",
  gacha_action_error_code_203: "Dieses Produkt kann nicht gekauft werden",
  gacha_action_error_code_204: "Zu viele Verbindungen, bitte versuchen Sie es erneut",
  gacha_action_error_code_205: "Dieses Produkt kann nicht gekauft werden",
  gacha_action_error_code_206: "Dieses Produkt kann nicht gekauft werden",
  gacha_action_error_code_207: "Dieses Produkt kann nicht gekauft werden",
  gacha_action_error_code_208: "Dieses Produkt kann nicht gekauft werden",
  gacha_action_error_code_301: "Dieses Produkt kann nicht gekauft werden",
  gacha_action_error_code_302: "Dieses Produkt kann nicht gekauft werden",
  gacha_action_error_code_303: "Dieses Produkt kann nicht gekauft werden",
  gacha_action_error_code_null: "Zu viele Verbindungen, bitte versuchen Sie es erneut",

  Please_enter_your_shipping_name: "Bitte geben Sie den Namen des Empfängers des Pakets ein.",
  Please_enter_your_shipping_zipcode: "Bitte geben Sie die Postleitzahl des Zielortes des Pakets ein.",
  Please_enter_your_shipping_address: "Bitte geben Sie die Lieferadresse ein",
  Please_enter_your_shipping_tel: "Bitte geben Sie die Telefonnummer der Lieferadresse ein",

  Gift_nema: 'Geschenkname',
  bonus_oripa: "Bonusprodukte",
  logout: "Abmelden",
  pre_opening: "vor der Eröffnung",
  userShippingName: "Name des Paketempfängers",
  userShippingZipcode: "Postleitzahl der Zustellung",
  userShippingAddress: "Lieferadresse",
  userShippingTel: "Telefonnummer für die Lieferung",
  userDefault: "Legen Sie dieses Ziel als Standard fest",
  faq: 'FAQ',
  Everyones_posts: 'Jedermanns Beiträge',
  unable_shipping_item_exists: 'Es existiert ein Artikel, der nicht versendet werden kann',
  Video_playback_failure: 'Fehler bei der Videowiedergabe',
  This_winning_result_has_been_added_to_your_collection: "Dieses Gewinnerergebnis wurde Ihrer Sammlung hinzugefügt",
  Please_play_in_a_place_with_good_communication_environment: "Bitte spielen Sie an einem Ort mit guter Kommunikationsumgebung",
  If_you_close_your_browser_and_access_it_again_you_will_be_less_likely_to_experience_playback_failures: "Wenn Sie Ihren Browser schließen und erneut darauf zugreifen, ist die Wahrscheinlichkeit von Wiedergabefehlern geringer",
  Invite_your_friends_and_get_great_benefits: "Lade deine Freunde ein und sichere dir tolle Vorteile",
  Your_friend_will_become_a_member_of_Cardel_using_the_referral_code_and_benefits_will_be_delivered_to_each_others_gift_box_after_SMS_authentication_is_completed: "Ihr Freund wird mithilfe des Empfehlungscodes Mitglied bei Cardel und die Vorteile werden nach Abschluss der SMS-Authentifizierung in die Geschenkbox des anderen verschickt",
  Introduction_URL_if_you_cannot_use_QR_code: "Einführungs-URL, wenn Sie keinen QR-Code verwenden können",
  When_entering_the_invitation_code_directly_please_use_the_numbers_below: "Wenn Sie den Einladungscode direkt eingeben, verwenden Sie bitte die untenstehenden Zahlen",
  invitation_code: "Einladungscode",
  Please_enter_your_invitation_code: "Bitte geben Sie Ihren Einladungscode ein",
  Only_if_you_have: "Bitte geben Sie Ihren Einladungscode ein",
  SMS_authentication: "SMS-Authentifizierung",
  SMS_authenticated: "SMS authenticate",
  Please_enter_a_phone_number_that_can_receive_SMS: "Bitte geben Sie eine Telefonnummer ein, die SMS empfangen kann",
  Only_phone_numbers_in_your_area_of_residence_can_be_used_for_SMS_verification: 'Für die SMS-Verifizierung können nur Telefonnummern in Ihrem Wohnort verwendet werden',
  SMS_authentication_cannot_be_performed_multiple_times_with_the_same_phone_number: 'Die SMS-Authentifizierung kann nicht mehrmals mit derselben Telefonnummer durchgeführt werden',
  The_verification_code_will_arrive_within_5_minutes: "Der Bestätigungscode wird innerhalb von 5 Minuten eintreffen",
  Send_SMS: "SMS senden",
  Send_SMS_again: "SMS senden",
  Please_enter_your_phone_number: "Bitte geben sie ihre Telefonnummer ein",
  Please_check_your_phone_number: "Bitte überprüfen Sie Ihre Telefonnummer",
  SMS_sent_completed: "SMS-Versand abgeschlossen",
  authentication_code: "SMS-Versand abgeschlossen",
  Please_enter_the_verification_code_received_via_SMS: "Bitte geben Sie den per SMS erhaltenen Bestätigungscode ein",
  If_you_do_not_receive_the_verification_code_via_SMS__please_send_it_again: "Wenn Sie den Bestätigungscode nicht per SMS erhalten. Bitte schicke es noch einmal",
  Send_verification_code: "Bestätigungscode senden",
  antique: 'Gebrauchtwarenwirtschaftsrecht',
  address_level1: "Präfekturen",
  address_level2: "Stadt/Bezirk/Kleinstadt/Dorf",
  address_line1: "Ortsname/Blocknummer",
  address_line2: "Gebäudename/Gebäudename usw.",
  ...
  currently_busy: "momentan beschäftigt",
  MultipleAccountCreationError: "Fehler bei der Erstellung mehrerer Konten",
  Log_in_with_an_already_created_account: 'Melden Sie sich mit einem bereits erstellten Konto an',
  Please_wait_a_while_and_try_again: 'Bitte warten Sie eine Weile und versuchen Sie es erneut',
  If_you_have_trouble_creating_an_account__please_contact_support: 'Wenn Sie Probleme beim Erstellen eines Kontos haben. Bitte wenden Sie sich an den Support',
  Thank_you_for_your_cooperation_in_maintaining_fairness: "Vielen Dank für Ihre Mitarbeit bei der Wahrung der Fairness.",
  Last_creation_date_and_time: 'Datum und Uhrzeit der letzten Erstellung',
  This_creation_date_and_time: 'Dieses Erstellungsdatum und diese Uhrzeit',
  MultipleEnterCouponCodeError: 'Erkennung von Couponbetrug',
  If_you_have_trouble_using_coupons__please_contact_support: 'Wenn Sie Probleme bei der Verwendung von Gutscheinen haben. Bitte wenden Sie sich an den Support',
  Under_maintenance: 'Wird gewartet',
  Currently_undergoing_maintenance: 'Wird derzeit gewartet',
  No_maintenance_scheduled_at_this_time: 'Derzeit sind keine Wartungsarbeiten geplant',
  Scheduled_start_date_and_time: 'Geplantes Startdatum und -uhrzeit',
  Scheduled_end_date_and_time: 'Geplantes Enddatum und -uhrzeit',
  Version_update_contents: 'Inhalt der Versionsaktualisierung',
  BillingLock: 'Die Abrechnung ist eingeschränkt',
  Unable_to_purchase_product: 'Produkt kann nicht gekauft werden',
  If_you_have_trouble_purchasing_a_product__please_contact_support: 'Wenn Sie Probleme beim Kauf eines Produkts haben. Bitte wenden Sie sich an den Support',
  this_phone_number_is_not_available: "Diese Telefonnummer ist nicht verfügbar",
  Please_check_your_sms_token: "Bitte überprüfen Sie Ihr SMS-Token",
  Depending_on_the_delivery_situation__it_may_take_several_days_from_shipping_to_delivery: 'Abhängig von der Liefersituation. Vom Versand bis zur Lieferung kann es mehrere Tage dauern',
