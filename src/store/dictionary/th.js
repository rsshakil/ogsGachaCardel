...
const commonErrorEn = defaultMessages.th;

//タイ語
const th = {
  CARDEL: "CARDEL",
  official_site: "เว็บไซต์อย่างเป็นทางการ",
  meta_description: "'Cardel' เป็นบริการเกมลอตเตอรีสำหรับผลิตภัณฑ์ออนไลน์ของ TCG รวมถึง 'การ์ดโปเกมอน' และ 'Yu-Gi-Oh! การ์ด' คุณสามารถเพลิดเพลินกับ TCG ด้วยเกมลอตเตอรีออนไลน์พร้อมเอฟเฟกต์",

  gacha: "gacha",
  Carefully_selected_original_pack: "แพ็คต้นฉบับที่คัดสรรมาอย่างดี",
  Layout_test: "Layout test",
  Bonus_oripa: "โบนัส",
  Pick_up_items: "หยิบของ",

  top: "หน้าแรก",
  operating_company: "บริษัทประกอบการ",
  terms_of_Use: "ข้อกำหนดการใช้งาน",
  privacy_policy: "นโยบายความเป็นส่วนตัว",
  Specified_Commercial_Transaction_Act: "พระราชบัญญัติธุรกรรมทางการค้าที่ระบุ",
  Customer_Service: "บริการลูกค้า",
  information: "ข้อมูล",
  card_number: "การ์ด{ number }ใบ",
  draw_n_card: "วาด { number }",
  draw_all_card: "จั่วไพ่ทั้งหมด",
  pay: "จ่าย",
  Guaranteed_last_prize: "รับรองรางวัลสุดท้าย.",
  ceiling: "โบนัสเพดาน",
  select: "เลือก",
  Unable_to_ship: 'ไม่สามารถจัดส่งได้',
  Waiting_for_shipping: 'รอจัดส่งครับ',
  Shipping_completed: 'จัดส่งเรียบร้อยแล้ว',
  Shipping_processing: 'กระบวนการเสร็จสมบูรณ์',
  Shipping_Address: 'ที่อยู่จัดส่ง',
  Default_shipping_address: 'ที่อยู่จัดส่งเริ่มต้น',
  Edit_Shipping_address: 'แก้ไขที่อยู่จัดส่ง',
  Add_new_delivery_address: 'เพิ่มที่อยู่จัดส่งใหม่',
  Confirm_Shipping_Address: 'ยืนยันที่อยู่จัดส่ง',
  skip_video: 'ข้ามวิดีโอ',
  Hit: 'ตี!',
  Hit_it_hard: 'กระแทกแรง!!!',
  Donot_miss_it: "อย่าพลาด!",
  more_more: 'มากขึ้นอีก!',
  Break_through: 'การฝ่าฟันอุปสรรค!!',
  deadline: 'วันกำหนดส่ง',
  shipping_method: 'วิธีการจัดส่งสินค้า',
  Card_to_be_shipped: 'บัตรที่จะจัดส่ง',
  Ship_selected_cards: 'จัดส่งการ์ดที่เลือก',
  Uses_300pt: "ใช้ 300 แต้ม",
  deposit: "เงินฝาก",
  _200_points_will_be_returned_after_shipping_is_completed: "จะมีการคืนคะแนน 200 คะแนนหลังจากจัดส่งเสร็จสิ้น",
  It_may_take_up_to_2_weeks_for_shipping_to_be_completed: "อาจใช้เวลาถึง 2 สัปดาห์ในการจัดส่งให้เสร็จสิ้น",
  Press_the_Confirm_button_to_confirm_the_shipping_request: "เมื่อคุณกดปุ่มยืนยัน ใบสมัครจัดส่งของคุณจะได้รับการยืนยัน",
  Shipping_application: 'ใบสมัครจัดส่ง',
  game_history: 'ประวัติเกม',
  Pack_opening_results: 'ผลการเปิดแพ็ค',
  Exchange_all_points: 'แลกแต้มทั้งหมด',
  Exchange_all_cards_into_points: 'แลกเปลี่ยนการ์ดทั้งหมดเป็นคะแนน',
  Exchange_selected_cards_into_points: "แลกเปลี่ยนการ์ดที่เลือกเป็นคะแนน",
  Exchange_cards_for_points: "แลกบัตรเป็นคะแนน",
  Collect_selected_cards: 'รวบรวมการ์ดที่เลือก',
  Exchange_selected_cards: 'แลกเปลี่ยนการ์ดที่เลือก',
  Confirmation_of_point_redemption: 'การยืนยันการแลกคะแนน',
  Point_redemption_completed: 'การแลกคะแนนเสร็จสมบูรณ์',
  Confirmation_of_collection: 'การยืนยันการสะสม',
  Store_selected_cards_in_collection: 'เก็บการ์ดที่เลือกไว้ในคอลเลกชัน',
  Cards_that_are_not_selected_will_be_automatically_converted_into_points: '*การ์ดที่ไม่ได้เลือกจะถูกแปลงเป็นแต้มโดยอัตโนมัติ',
  Cards_that_have_been_converted_into_points_cannot_be_returned: '*บัตรที่แปลงเป็นแต้มแล้วไม่สามารถคืนได้',
  Cards_stored_in_the_collection____: '*บัตรที่เก็บไว้ในคอลเลกชันจะถูกแปลงเป็นคะแนนโดยอัตโนมัติหลังจากพ้นกำหนดเวลาคำขอจัดส่ง (3 สัปดาห์)',
  Collection_completed: 'การรวบรวมเสร็จสมบูรณ์',
  Collection_List: 'รายการคอลเลกชัน',
  Gift_Box: 'กล่องของขวัญ',
  receive_gift: 'รับ',
  Successfully_received_the_gift: "รับของขวัญเรียบร้อยแล้ว",
  Coupon: 'คูปอง',
  Coupon_code: 'รหัสคูปอง',
  use_coupon: 'ใช้คูปอง',
  enter_coupon: 'ใส่คูปอง',
  please_enter_your_coupon: "กรุณากรอกรหัสคูปอง",
  Coupon_code_is_invalid: 'รหัสคูปองไม่ถูกต้อง',
  Coupon_used_successfully: "ใช้คูปองสำเร็จ",
  login: "ลงชื่อเข้าใช้",
  sign_up: "สมัครสมาชิก",
  ...
  close: "ปิด",
  Back: 'กลับ',
  error: "ข้อผิดพลาด { text }",
  credit_card: 'บัตรเครดิต',
  Confirmation_of_consumption_points: "การยืนยันจุดการบริโภค",
  Confirm_payment_method: 'ยืนยันวิธีการชำระเงิน',
  Thank_you_for_signing_up: "ขอบคุณที่ลงทะเบียน",
  Enjoy_cardel: "เพลิดเพลินไปกับ 'คาร์เดล'",
  Purchase_points: "ลงทะเบียน",
  Points_to_purchase: "คะแนนที่จะซื้อ",
  Payment_method: 'วิธีการชำระเงิน',
  Please_select_from_the_buttons_at_the_bottom: "กรุณาเลือกจากปุ่มด้านล่าง",
  insufficient_points: "คะแนนไม่เพียงพอ",
  Password: "รหัสผ่าน",
  Current_Password: 'รหัสผ่านปัจจุบัน',
  New_Password: 'รหัสผ่านใหม่',
  Reset_password: "รีเซ็ตรหัสผ่าน",
  Country_of_residence: 'ยืนยันที่อยู่จัดส่ง',
  Country_of_residence_registration: 'การลงทะเบียนประเทศที่พำนัก',
  Confirm_email_address: "ยืนยันที่อยู่อีเมล",
  Change_email_address: "เปลี่ยนที่อยู่อีเมลล์",
  email_address: "ที่อยู่อีเมล",
  Email_sent_success: "ส่งอีเมลสำเร็จแล้ว",
  Registered_email_address: "ที่อยู่อีเมลที่ลงทะเบียน",
  New_email_address: 'ที่อยู่อีเมลใหม่',
  Send_the_authentication_URL_your_new_email_address: 'ส่ง URL การยืนยันไปยังที่อยู่อีเมลใหม่ของคุณ',
  Send_to_registered_email_address: 'คำแนะนำในการรีเซ็ตรหัสผ่านจะถูกส่งไปยังที่อยู่อีเมลที่คุณลงทะเบียนไว้',
  Please_enter_your_email_address: "กรุณากรอกอีเมลของคุณ",
  Please_enter_your_password: "กรุณาใส่รหัสผ่านของคุณ",
  please_enter_your_confirmation_password: "กรุณากรอกรหัสผ่านยืนยันของคุณ",
  password_and_confirmation_password_do_not_match: "กรุณากรอกรหัสผ่านยืนยันของคุณ",
  authentication_failed_Please_try_again: "รับรองความถูกต้องล้มเหลว. กรุณาลองอีกครั้ง",
  login_failed_Please_try_again: "การลงชื่อเข้าใช้ล้มเหลว โปรดลองอีกครั้งในเครือข่ายที่ดีที่สุดของคุณ",
  new_registration_failed: "New registration failed.",

  Forgot_password: "ลืมรหัสผ่าน?",
  Change_Password: 'เปลี่ยนรหัสผ่าน',
  Password_change_completed: 'การเปลี่ยนรหัสผ่านเสร็จสมบูรณ์',
  Shipping_application_confirmation: 'การยืนยันการสมัครจัดส่ง',
  Shipping_application_completed: 'การสมัครจัดส่งเสร็จสมบูรณ์',
  Please_look_forward_to_your_card_arriving: "กรุณาตั้งตารอที่บัตรของคุณจะมาถึง",
  For_checking: "สำหรับการตรวจสอบ",
  There_is_an_error_in_the_confirmation_email_address: "มีข้อผิดพลาดในที่อยู่อีเมลยืนยัน",
  This_email_address_is_in_use: "ที่อยู่อีเมลนี้มีการใช้งานอยู่",
  I_will_register_as_a_member_after_agreeing_to_the_terms_of_use_and_privacy_policy_of_this_service: "ฉันจะลงทะเบียนเป็นสมาชิกหลังจากยอมรับเงื่อนไขการใช้งานและนโยบายความเป็นส่วนตัวของบริการนี้",
  Password_format_error: "รหัสผ่านต้องมีความยาวระหว่าง 6 ถึง 32 อักขระและตัวเลขและสัญลักษณ์ขนาดความกว้างครึ่งความกว้าง",
  Your_email_address_has_been_confirmed: "ที่อยู่อีเมลของคุณได้รับการยืนยันแล้ว",
  A_confirmation_email_has_been_sent_to_your_email_address: "อีเมลยืนยันได้ถูกส่งไปยังที่อยู่อีเมลของคุณแล้ว",
  Please_click_on_the_URL_in_the_email_body_to_proceed_to_main_registration: "กรุณาคลิกที่ URL ในเนื้อหาอีเมลเพื่อดำเนินการลงทะเบียนหลัก",
  Instructions_to_reset_your_password_have_been_sent_to_your_email_address: "คำแนะนำในการรีเซ็ตรหัสผ่านได้ถูกส่งไปยังที่อยู่อีเมลของคุณแล้ว.",
  If_you_do_not_receive_the_verification_email: "หากคุณไม่ได้รับอีเมลยืนยัน",
  There_may_be_an_error_in_your_email_address__Please_register_again_with_the_correct_email_address: "อาจมีข้อผิดพลาดในที่อยู่อีเมลของคุณ กรุณาลงทะเบียนอีกครั้งด้วยที่อยู่อีเมลที่ถูกต้อง",
  The_verification_email_may_arrive_in_your_spam_folder_Please_check_your_spam_folder: "อาจได้รับอีเมลยืนยันในโฟลเดอร์สแปมของคุณ โปรดตรวจสอบโฟลเดอร์สแปมของคุณ",
  Please_set_your_settings_so_that_you_can_receive_emails_from: "โปรดเปิดใช้งานการรับอีเมลจาก { email }.",
  Set_new_password: 'ตั้งรหัสผ่านใหม่',
  Notes_on_regional_registration: "คุณไม่สามารถเปลี่ยนประเทศที่คุณพำนักได้ หากคุณลงทะเบียนประเทศที่พำนักของคุณไม่ถูกต้อง โปรดติดต่อฝ่ายสนับสนุนลูกค้า",
  This_product_is_sold_out: 'สินค้าชิ้นนี้จำหน่ายหมดแล้ว',
  Players_are_flooding_in_Please_try_again: 'ผู้เล่นหลั่งไหลเข้ามามากมาย โปรดลองอีกครั้ง',
  A_system_error_has_occurred__Please_try_again: "เกิดข้อผิดพลาดของระบบ กรุณาลองอีกครั้ง",
  Opening_in: 'กำลังเปิดใน',
  day: 'วัน',
  hour: 'ชั่วโมง',
  minutes: 'นาที',
  seconds: 'ไม่กี่วินาที',
  will_be_released: 'จะถูกปล่อย',
  account_cannnot_be_used_to_purchase: 'บัญชีนี้ไม่สามารถใช้ในการซื้อได้',

  gacha_action_error_code_102: "ไม่สามารถซื้อผลิตภัณฑ์นี้ได้",
  gacha_action_error_code_202: "มีการเชื่อมต่อมากเกินไป โปรดลองอีกครั้ง",
  gacha_action_error_code_203: "ไม่สามารถซื้อผลิตภัณฑ์นี้ได้",
  gacha_action_error_code_204: "มีการเชื่อมต่อมากเกินไป โปรดลองอีกครั้ง",
  gacha_action_error_code_205: "ไม่สามารถซื้อผลิตภัณฑ์นี้ได้",
  gacha_action_error_code_206: "ไม่สามารถซื้อผลิตภัณฑ์นี้ได้",
  gacha_action_error_code_207: "ไม่สามารถซื้อผลิตภัณฑ์นี้ได้",
  gacha_action_error_code_208: "ไม่สามารถซื้อผลิตภัณฑ์นี้ได้",
  gacha_action_error_code_301: "ไม่สามารถซื้อผลิตภัณฑ์นี้ได้",
  gacha_action_error_code_302: "ไม่สามารถซื้อผลิตภัณฑ์นี้ได้",
  gacha_action_error_code_303: "ไม่สามารถซื้อผลิตภัณฑ์นี้ได้",
  gacha_action_error_code_null: "มีการเชื่อมต่อมากเกินไป โปรดลองอีกครั้ง",

  Please_enter_your_shipping_name: "กรุณากรอกชื่อผู้รับพัสดุ",
  Please_enter_your_shipping_zipcode: "กรุณากรอกรหัสไปรษณีย์ของปลายทางของพัสดุ",
  Please_enter_your_shipping_address: "กรุณากรอกที่อยู่ในการจัดส่ง",
  Please_enter_your_shipping_tel: "กรุณากรอกหมายเลขโทรศัพท์ที่อยู่ในการจัดส่ง",


  Gift_nema: 'ชื่อของขวัญ',
  bonus_oripa: "ผลิตภัณฑ์โบนัส",
  logout: "ออกจากระบบ",
  pre_opening: "ก่อนเปิด",


  userShippingName: "ชื่อผู้รับพัสดุ",
  userShippingZipcode: "รหัสไปรษณีย์สำหรับจัดส่ง",
  userShippingAddress: "ที่อยู่สำหรับการจัดส่ง",
  userShippingTel: "หมายเลขโทรศัพท์จัดส่ง",
  userDefault: "ตั้งค่าปลายทางนี้เป็นค่าเริ่มต้น",
  faq: 'FAQ',
  Everyones_posts: 'กระทู้ของทุกคน.',
  unable_shipping_item_exists: 'มีรายการที่ไม่สามารถจัดส่งได้',
  Video_playback_failure: 'การเล่นวิดีโอล้มเหลว',
  This_winning_result_has_been_added_to_your_collection: "ผลลัพธ์ที่ชนะนี้ได้ถูกเพิ่มไปยังคอลเลกชันของคุณแล้ว",
  Please_play_in_a_place_with_good_communication_environment: "กรุณาเล่นในสถานที่ที่มีสภาพแวดล้อมการสื่อสารที่ดี",
  If_you_close_your_browser_and_access_it_again_you_will_be_less_likely_to_experience_playback_failures: "หากคุณปิดเบราว์เซอร์และเข้าถึงอีกครั้ง คุณจะมีโอกาสประสบกับความล้มเหลวในการเล่นน้อยลง",
  Invite_your_friends_and_get_great_benefits: "เชิญเพื่อนของคุณและรับสิทธิประโยชน์มากมาย",
  Your_friend_will_become_a_member_of_Cardel_using_the_referral_code_and_benefits_will_be_delivered_to_each_others_gift_box_after_SMS_authentication_is_completed: "เพื่อนของคุณจะกลายเป็นสมาชิกของ Cardel โดยใช้รหัสอ้างอิงและสิทธิประโยชน์จะถูกส่งไปยังกล่องของขวัญของกันและกันหลังจากการตรวจสอบความถูกต้องทาง SMS เสร็จสิ้น",
  Introduction_URL_if_you_cannot_use_QR_code: "URL บทนำหากคุณไม่สามารถใช้รหัส QR ได้",
  When_entering_the_invitation_code_directly_please_use_the_numbers_below: "เมื่อกรอกรหัสเชิญโดยตรง กรุณาใช้ตัวเลขด้านล่าง",
  invitation_code: "รหัสการเชิญ",
  Please_enter_your_invitation_code: "กรุณากรอกรหัสเชิญของคุณ",
  Only_if_you_have: "กรุณากรอกรหัสเชิญของคุณ",
  SMS_authentication: "การตรวจสอบสิทธิ์ทาง SMS",
  SMS_authenticated: "SMS รับรองความถูกต้องแล้ว",
  Please_enter_a_phone_number_that_can_receive_SMS: "กรุณากรอกหมายเลขโทรศัพท์ที่สามารถรับ SMS ได้",
  Only_phone_numbers_in_your_area_of_residence_can_be_used_for_SMS_verification: 'เฉพาะหมายเลขโทรศัพท์ในพื้นที่ที่คุณอาศัยอยู่เท่านั้นที่สามารถใช้เพื่อการยืนยันทาง SMS',
  SMS_authentication_cannot_be_performed_multiple_times_with_the_same_phone_number: 'การรับรองความถูกต้องทาง SMS ไม่สามารถดำเนินการได้หลายครั้งด้วยหมายเลขโทรศัพท์เดียวกัน',
  The_verification_code_will_arrive_within_5_minutes: "รหัสยืนยันจะมาถึงภายใน 5 นาที",
  Send_SMS: "ส่ง SMS",
  Send_SMS_again: "ส่ง SMS",
  Please_enter_your_phone_number: "กรุณากรอกหมายเลขโทรศัพท์ของคุณ",
  Please_check_your_phone_number: "กรุณาตรวจสอบหมายเลขโทรศัพท์ของคุณ",
  SMS_sent_completed: "ส่ง SMS เรียบร้อยแล้ว",
  authentication_code: "ส่ง SMS เรียบร้อยแล้ว",
  Please_enter_the_verification_code_received_via_SMS: "กรุณากรอกรหัสยืนยันที่ได้รับทาง SMS",
  If_you_do_not_receive_the_verification_code_via_SMS__please_send_it_again: "หากคุณไม่ได้รับรหัสยืนยันทาง SMS กรุณาส่งอีกครั้ง",
  Send_verification_code: "ส่งรหัสยืนยัน",
  antique: 'จัดแสดงตามกฎหมายธุรกิจสินค้ามือสอง',
  address_level1: "จังหวัด",
  address_level2: "เมือง/วอร์ด/เมือง/หมู่บ้าน",
  address_line1: "ชื่อเมือง/หมายเลขบล็อก",
  address_line2: "ชื่ออาคาร/ชื่ออาคาร ฯลฯ",
  ...
  required: "ที่จำเป็น",
  currently_busy: "กำลังยุ่งอยู่",
  MultipleAccountCreationError: "เกิดข้อผิดพลาดในการสร้างบัญชีหลายบัญชี",
  Log_in_with_an_already_created_account: 'เข้าสู่ระบบด้วยบัญชีที่สร้างไว้แล้ว',
  Please_wait_a_while_and_try_again: 'โปรดรอสักครู่สักครู่และลองอีกครั้ง',
  If_you_have_trouble_creating_an_account__please_contact_support: 'หากคุณประสบปัญหาในการสร้างบัญชี โปรดติดต่อฝ่ายสนับสนุน',
  Thank_you_for_your_cooperation_in_maintaining_fairness: "ขอขอบคุณที่ให้ความร่วมมือในการรักษาความเป็นธรรม",
  Last_creation_date_and_time: 'วันที่และเวลาที่สร้างครั้งล่าสุด',
  This_creation_date_and_time: 'วันและเวลาที่สร้างนี้',
  MultipleEnterCouponCodeError: 'การตรวจจับการฉ้อโกงคูปอง',
  If_you_have_trouble_using_coupons__please_contact_support: 'หากคุณมีปัญหาในการใช้คูปอง โปรดติดต่อฝ่ายสนับสนุน',
  Under_maintenance: 'ภายใต้การบำรุงรักษา',
  Currently_undergoing_maintenance: 'ขณะนี้อยู่ในระหว่างการบำรุงรักษา',
  No_maintenance_scheduled_at_this_time: 'ไม่มีกำหนดการบำรุงรักษาในขณะนี้',
  Scheduled_start_date_and_time: 'วันที่และเวลาเริ่มต้นที่กำหนดไว้',
  Scheduled_end_date_and_time: 'วันที่และเวลาสิ้นสุดตามกำหนดการ',
  Version_update_contents: 'เนื้อหาการอัพเดตเวอร์ชัน',
  BillingLock: 'การเรียกเก็บเงินถูกจำกัด',
  Unable_to_purchase_product: 'ไม่สามารถซื้อสินค้าได้',
  If_you_have_trouble_purchasing_a_product__please_contact_support: 'หากคุณมีปัญหาในการซื้อสินค้า โปรดติดต่อฝ่ายสนับสนุน',
  this_phone_number_is_not_available: "หมายเลขโทรศัพท์นี้ไม่สามารถใช้ได้",
  Please_check_your_sms_token: "โปรดตรวจสอบโทเค็น SMS ของคุณ",
  Depending_on_the_delivery_situation__it_may_take_several_days_from_shipping_to_delivery: 'ขึ้นอยู่กับสถานการณ์การจัดส่ง อาจใช้เวลาหลายวันในการจัดส่งจนถึงการจัดส่ง',
