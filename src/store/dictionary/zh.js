...
const commonErrorEn = defaultMessages.zh;

//　❗️❗️❗️中国語 (繁体)
const zh = {
  CARDEL: "卡德爾",
  official_site: "官方網站",
  meta_description: "“Cardel”是 TCG 線上產品的彩票遊戲服務，包括“神奇寶貝卡”和“遊戲王！” 牌。' 您可以透過帶有效果的線上彩票遊戲來享受TCG。",

  gacha: "gacha",
  Carefully_selected_original_pack: "嚴選原包裝",
  ...
  top: "首頁",
  operating_company: "營運公司",
  terms_of_Use: "使用條款",
  privacy_policy: "隱私權政策",
  Specified_Commercial_Transaction_Act: "特定商業交易法",
  Customer_Service: "客戶服務",
  information: "資訊",
  card_number: "{ number }張牌",
  draw_n_card: "抽籤 { number }",
  draw_all_card: "抽取所有卡牌",
  pay: "支付",
  Guaranteed_last_prize: "保證最後獎品",
  skip_video: '跳過視頻',
  ceiling: "上限獎金",
  Hit: '打！',
  Hit_it_hard: '使勁打吧！！!',
  ...
  Card_to_be_shipped: '待出貨卡',
  Ship_selected_cards: '運送選定的卡片',
  Uses_300pt: "使用300積分",
  deposit: "訂金",
  _200_points_will_be_returned_after_shipping_is_completed: "出貨完成後返還200積分",
  It_may_take_up_to_2_weeks_for_shipping_to_be_completed: "運送可能需要 2 週才能完成。",
  Press_the_Confirm_button_to_confirm_the_shipping_request: "當您按下確認按鈕時，您的運送申請將被確認",
  Shipping_application: '運送申請',
  Shipping_application_confirmation: '出貨申請確認',
  Shipping_application_completed: '出貨申請完成',
  Please_look_forward_to_your_card_arriving: "請期待您的卡到達",
  game_history: '遊戲歷史',
  Pack_opening_results: '開包結果',
  Exchange_all_points: '兌換所有積分',
  Exchange_all_cards_into_points: '將所有卡兌換成積分',
  Exchange_selected_cards_into_points: "將選定的卡片兌換成積分",
  Exchange_cards_for_points: "用卡片換積分",
  Collect_selected_cards: '收集選定的卡片',
  Exchange_selected_cards: '交換選定的卡',
  Confirmation_of_point_redemption: '確認積分兌換',
  Point_redemption_completed: '積分兌換完成',
  Confirmation_of_collection: '確認領取',
  Store_selected_cards_in_collection: '將選定的卡片儲存在集合中',
  Cards_that_are_not_selected_will_be_automatically_converted_into_points: '*未選擇的卡牌將自動轉換為積分。',
  Cards_that_have_been_converted_into_points_cannot_be_returned: '*已轉換為積分的卡片無法退回。',
  Cards_stored_in_the_collection____: '*收藏中儲存的卡片將在出貨請求截止日期（3 週）過後自動轉換為積分。',
  Collection_completed: '收藏完畢',
  Collection_List: '收藏清單',
  Gift_Box: '禮物盒',
  receive_gift: '收到',
  Successfully_received_the_gift: "成功收到禮物",
  Coupon: '優惠券',
  Coupon_code: '優惠券代碼',
  use_coupon: '使用優惠券',
  enter_coupon: '輸入優惠券',
  please_enter_your_coupon: "請輸入優惠券代碼",
  Coupon_code_is_invalid: '優惠券代碼無效',
  Coupon_used_successfully: "優惠券使用成功",
  select: "選擇",
  Unable_to_ship: '無法出貨',
  Waiting_for_shipping: '等待發貨',
  Shipping_completed: '運送完成',
  Shipping_Address: '收件地址',
  Default_shipping_address: '預設送貨地址',
  Edit_Shipping_address: '編輯送貨地址',
  Add_new_delivery_address: '新增新的送貨地址',
  Confirm_Shipping_Address: '確認送貨地址',
  ...
  error: "{ text }錯誤",
  credit_card: '信用卡',
  Confirmation_of_consumption_points: "消費積分確認",
  Confirm_payment_method: '確認付款方式',
  Thank_you_for_signing_up: "謝謝您註冊",
  Enjoy_cardel: "享受“卡德爾”",
  Purchase_points: "購買積分",
  Points_to_purchase: "購買積分",
  Payment_method: '付款方式',
  Please_select_from_the_buttons_at_the_bottom: "請從底部的按鈕中選擇",
  insufficient_points: "積分不足",
  Password: "密碼",
  Current_Password: '目前密碼',
  New_Password: '新密碼',
  Reset_password: "重新設密碼",
  Country_of_residence: '確認送貨地址',
  Country_of_residence_registration: '居住登記國家',
  Confirm_email_address: "確認電子郵件地址",
  Change_email_address: "更改電子郵件地址",
  email_address: "電子郵件地址",
  Email_sent_success: "郵件發送成功",
  Registered_email_address: "註冊的電子郵件地址",
  New_email_address: '新電子郵件地址',
  Send_the_authentication_URL_your_new_email_address: '將驗證 URL 傳送到您的新電子郵件地址',
  Send_to_registered_email_address: '重設密碼的說明將發送至您註冊的電子郵件地址。',
  Please_enter_your_email_address: "請輸入您的電子郵件地址",
  Please_enter_your_password: "請輸入您的密碼",
  please_enter_your_confirmation_password: "請輸入您的確認密碼",
  password_and_confirmation_password_do_not_match: "密碼和確認密碼不匹配",
  authentication_failed_Please_try_again: "認證失敗。 請再試一次",
  login_failed_Please_try_again: "登入失敗。請重試",
  new_registration_failed: "新註冊失敗",

  Forgot_password: "忘記密碼？",
  Change_Password: '更改密碼',
  Set_new_password: '設定新密碼',
  Password_change_completed: '密碼修改完成',
  For_checking: "用於檢查",
  There_is_an_error_in_the_confirmation_email_address: "確認電子郵件地址有誤",
  This_email_address_is_in_use: "此電子郵件地址已被使用",
  I_will_register_as_a_member_after_agreeing_to_the_terms_of_use_and_privacy_policy_of_this_service: "我在同意本服務的使用條款和隱私權政策後將註冊成為會員",
  Password_format_error: "密碼必須介於 6 到 32 個半角字母數字字元和符號之間",
  Your_email_address_has_been_confirmed: "您的電子郵件地址已被確認",
  A_confirmation_email_has_been_sent_to_your_email_address: "確認電子郵件已發送至您的電子郵件地址",
  Please_click_on_the_URL_in_the_email_body_to_proceed_to_main_registration: "請點擊電子郵件正文中的 URL 進行主要註冊",
  Instructions_to_reset_your_password_have_been_sent_to_your_email_address: "重設密碼的說明已發送至您的電子郵件地址.",
  If_you_do_not_receive_the_verification_email: "如果您沒有收到驗證電子郵件",
  If_you_do_not_receive_the_information_email: "如果您沒有收到資訊電子郵件",
  There_may_be_an_error_in_your_email_address__Please_register_again_with_the_correct_email_address: "您的電子郵件地址可能有誤。 請使用正確的郵箱地址重新註冊",
  The_verification_email_may_arrive_in_your_spam_folder_Please_check_your_spam_folder: "您的垃圾郵件資料夾中可能已收到驗證電子郵件。 請檢查您的垃圾郵件資料夾",
  Please_set_your_settings_so_that_you_can_receive_emails_from: "請啟用從 { email } 接收電子郵件",
  Notes_on_regional_registration: "您無法變更您的居住國家。 如果您註冊的居住國家/地區不正確，請聯絡客戶支援。",
  This_product_is_sold_out: '該產品已售完',
  Players_are_flooding_in_Please_try_again: '玩家蜂擁而至，請重試',
  A_system_error_has_occurred__Please_try_again: "發生系統錯誤。 請再試一次",
  Opening_in: '開業於',
  day: '日',
  hour: '小時',
  minutes: '分鍾',
  seconds: '秒',
  will_be_released: '會被釋放',
  account_cannnot_be_used_to_purchase: '該帳號不能用於購買',

  hello: "Hello, wang!",
  hello_name: "Hello, { my_name } !",
  gacha_action_error_code_102: "該產品無法購買",
  gacha_action_error_code_202: "連線數過多，請重試",
  gacha_action_error_code_203: "該產品無法購買",
  gacha_action_error_code_204: "連線數過多，請重試",
  gacha_action_error_code_205: "該產品無法購買",
  gacha_action_error_code_206: "該產品無法購買",
  gacha_action_error_code_207: "該產品無法購買",
  gacha_action_error_code_208: "該產品無法購買",
  gacha_action_error_code_301: "該產品無法購買",
  gacha_action_error_code_302: "該產品無法購買",
  gacha_action_error_code_303: "該產品無法購買",
  gacha_action_error_code_null: "連線數過多，請重試",

  Please_enter_your_shipping_name: "請輸入包裹收件人的姓名",
  Please_enter_your_shipping_zipcode: "請輸入包裹目的地的郵遞區號。",
  Please_enter_your_shipping_address: "請輸入送貨地址",
  Please_enter_your_shipping_tel: "請輸入送貨地址電話號碼",
  ...
  userShippingName: "包裹收件人姓名",
  userShippingZipcode: "送貨郵遞區號",
  userShippingAddress: "郵寄地址",
  userShippingTel: "送貨電話號碼",
  userDefault: "將此目的地設定為預設目的地",
  faq: 'FAQ',
  Everyones_posts: '大家的貼文',
  unable_shipping_item_exists: '存在無法運送的物品',
  Video_playback_failure: '影片播放失敗',
  This_winning_result_has_been_added_to_your_collection: "此獲獎結果已添加到您的收藏中",
  Please_play_in_a_place_with_good_communication_environment: "請在通訊環境良好的地方玩耍",
  If_you_close_your_browser_and_access_it_again_you_will_be_less_likely_to_experience_playback_failures: "如果您關閉瀏覽器並再次訪問，您將不太可能遇到播放失敗的情況",
  Invite_your_friends_and_get_great_benefits: "邀請好友，獲得豐厚福利",
  Your_friend_will_become_a_member_of_Cardel_using_the_referral_code_and_benefits_will_be_delivered_to_each_others_gift_box_after_SMS_authentication_is_completed: "您的好友使用推薦碼即可成為Cardel會員，簡訊驗證完成後福利將互贈禮盒",
  Introduction_URL_if_you_cannot_use_QR_code: "無法使用二維碼時的介紹 URL",
  When_entering_the_invitation_code_directly_please_use_the_numbers_below: "直接輸入邀請碼時，請使用下列數字",
  invitation_code: "邀請程式碼",
  Please_enter_your_invitation_code: "請輸入您的邀請碼",
  Only_if_you_have: "請輸入您的邀請碼",
  SMS_authentication: "簡訊驗證",
  SMS_authenticated: "簡訊驗證",
  Please_enter_a_phone_number_that_can_receive_SMS: "請輸入可以接收簡訊的電話號碼",
  Only_phone_numbers_in_your_area_of_residence_can_be_used_for_SMS_verification: '簡訊驗證只能使用您居住地區的電話號碼',
  SMS_authentication_cannot_be_performed_multiple_times_with_the_same_phone_number: '同一手機號碼不能多次進行簡訊驗證',
  The_verification_code_will_arrive_within_5_minutes: "驗證碼將在5分鐘內到達",
  Send_SMS: "發簡訊",
  Send_SMS_again: "發簡訊",
  Please_enter_your_phone_number: "請輸入您的電話號碼",
  Please_check_your_phone_number: "請檢查您的電話號碼",
  SMS_sent_completed: "簡訊發送完成",
  authentication_code: "簡訊發送完成",
  Please_enter_the_verification_code_received_via_SMS: "請輸入透過簡訊收到的驗證碼",
  If_you_do_not_receive_the_verification_code_via_SMS__please_send_it_again: "如果您沒有透過簡訊收到驗證碼。 請再發送一次",
  Send_verification_code: "發送驗證碼",
  antique: '根據二手商品交易法進行展示',
  address_level1: "都道府縣",
  address_level2: "市/區/鎮/村",
  address_line1: "城鎮名稱/街區編號",
  address_line2: "建築物名稱/建築物名稱等",
  ...
  required: "必需的",
  currently_busy: "目前很忙",
  MultipleAccountCreationError: "多帳戶建立錯誤",
  Log_in_with_an_already_created_account: '使用已建立的帳戶登入',
  Please_wait_a_while_and_try_again: '請稍等片刻然後重試',
  If_you_have_trouble_creating_an_account__please_contact_support: '如果您在建立帳戶時遇到問題。 請聯絡支援人員',
  Thank_you_for_your_cooperation_in_maintaining_fairness: "感謝您在維護公平方面的合作。",
  Last_creation_date_and_time: '上次建立日期和時間',
  This_creation_date_and_time: '此建立日期和時間',
  MultipleEnterCouponCodeError: '優惠券詐欺偵測',
  If_you_have_trouble_using_coupons__please_contact_support: '如果您在使用優惠券時遇到問題。 請聯絡支援人員',
  Under_maintenance: '正在維修',
  Currently_undergoing_maintenance: '目前正在維護中',
  No_maintenance_scheduled_at_this_time: '目前沒有安排維護',
  Scheduled_start_date_and_time: '預定開始日期和時間',
  Scheduled_end_date_and_time: '預定結束日期和時間',
  Version_update_contents: '版本更新內容',
  BillingLock: '計費受到限制',
  Unable_to_purchase_product: '無法購買產品',
  If_you_have_trouble_purchasing_a_product__please_contact_support: '如果您在購買產品時遇到困難。 請聯絡支援人員',
  this_phone_number_is_not_available: "該電話號碼無法接通",
  Please_check_your_sms_token: "請檢查您的簡訊令牌",
  Depending_on_the_delivery_situation__it_may_take_several_days_from_shipping_to_delivery: '視交貨情況而定。 從發貨到交貨可能需要幾天的時間',
