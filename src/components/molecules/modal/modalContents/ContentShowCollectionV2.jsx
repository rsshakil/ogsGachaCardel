...
export const ContentShowCollectionV2 = () => {
    const intl = useIntl()
    ...
    // console.log("sssssssssssss2", UserStateObj.myCollection[key].itemShippingFlag);
            ...
            <div className="w-full flex flex-row mt-4 justify-between items-center">
                <div 
                    className={`button-half-left button-green flex flex-row justify-center items-center touch-none select-none ${!hasPrevPage && '!cursor-default' }`}
                    // onClick={prevHistory}
                >
                    <p className="pointer-events-none text-base font-bold font-Roboto text-white">{intl.formatMessage({ id: 'Previous' })}</p>
                </div>
                <div 
                    className={`button-half-right button-green flex flex-row justify-center items-center touch-none select-none ${!hasNextPage && '!cursor-default'}`}
                    // onClick={nextHistory}
                >
                    <p className="pointer-events-none text-base font-bold font-Roboto text-white">{intl.formatMessage({ id: 'Next' })}</p>
                </div>
            </div>
