...
let testTimer;
export const ButtonWrapEnterEpsilonPurchaseForm2 = () => {
    const intl = useIntl()
    ...
    function MetodOfPaymentConfirm(e) {
        console.log("[ButtonWrapEnterEpsilonPurchaseForm2]closeModal e==>", e);
    ...
    async function doCheckout(e) {
        console.log("[ButtonWrapEnterEpsilonPurchaseForm2]doCheckout e==>", e);
