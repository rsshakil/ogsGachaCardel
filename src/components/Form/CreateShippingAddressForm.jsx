...
export const CreateShippingAddressForm = ({buttonElement}) => {
    const intl = useIntl();
    ...
    const [formData, setFormData] = useState({ 
        ...
        userShippingTelCCValue: UserStateObj.countryOfResidenceCode ? UserStateObj.countryOfResidenceCode.toLowerCase() : 'jp',
    ...
    useEffect(() => {
        ...
        if (data) {
            ...
            if(formDataValue) {
                let updatedFormData = {...formDataValue};

                if(!updatedFormData.userShippingTelCCValue){
                    updatedFormData.userShippingTelCCValue = formData.userShippingTelCCValue
                }
