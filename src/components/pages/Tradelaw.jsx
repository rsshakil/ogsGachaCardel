...
export const Tradelaw = () => {
    ...
    let pagePath = 'tradelaw';
    // let pageName = location.state?.data.name;
    let pageTitle = intl.formatMessage({ id: 'Specified_Commercial_Transaction_Act' }) + " | " + intl.formatMessage({ id: 'CARDEL' }) + " " + intl.formatMessage({ id: 'official_site' });
