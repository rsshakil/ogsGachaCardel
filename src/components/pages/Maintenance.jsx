...
import { TradeLaw } from "../molecules/TradeLaw";
import {useIntl} from 'react-intl'
import { QueryParameter } from "../../functions/QueryParameter";
import useMetaDescription from "../../hooks/useMetaDescription";
import { AntiqueLaw } from "../molecules/AntiqueLaw";
import { MaintenanceInfo } from "../molecules/MaintenanceInfo";
...
export const Maintenance = () => {
    ...
    let pagePath = 'maintenance';
    // let pageName = location.state?.data.name;
    let pageTitle = intl.formatMessage({ id: 'maintenance' }) + " | " + intl.formatMessage({ id: 'CARDEL' }) + " " + intl.formatMessage({ id: 'official_site' });
