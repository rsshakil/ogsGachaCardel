...
import { SnsSlider } from "../molecules/SnsSlider";
import { SnsInformation } from "../molecules/SnsInformation";
...
export const Sns = () => {
    ...
    let pageTitle = intl.formatMessage({ id: 'Everyones_posts' }) + " | " + intl.formatMessage({ id: 'CARDEL' }) + " " + intl.formatMessage({ id: 'official_site' });
