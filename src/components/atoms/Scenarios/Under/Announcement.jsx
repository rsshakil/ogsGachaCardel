...
export const Announcement = (props) => {
    ...
    // if(UndercardTickerCurrentTime === 0){
    //     // リセット処理
    //     if(isAllowDisplay !== 'hidden'){setIsAllowDisplay('hidden')}
    //     if(firstShot){setFirstShot(false)}
    //     if(secondShot){setSecondShot(false)}
    //     if(showBomb){setShowBomb(false)}
    //     if(showStamp){setShowStamp(false)}
    // }else if(UndercardTickerCurrentTime === 200){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  爆破　準備
    //     if(showBomb){setShowBomb(false)}
    //     //  確定　準備
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 400){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  爆破　準備
    //     if(showBomb){setShowBomb(false)}
    //     //  確定　準備
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 600){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  爆破　準備
    //     if(showBomb){setShowBomb(false)}
    //     //  確定　準備
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 800){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  爆破　準備
    //     if(showBomb){setShowBomb(false)}
    //     //  確定　準備
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 1000){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  爆破　準備
    //     if(showBomb){setShowBomb(false)}
    //     //  確定　準備
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 1200){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  爆破　準備
    //     if(showBomb){setShowBomb(false)}
    //     //  確定　準備
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 1400){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  爆破　準備
    //     if(showBomb){setShowBomb(false)}
    //     //  確定　準備
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 1600){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  爆破　準備
    //     if(showBomb){setShowBomb(false)}
    //     //  確定　準備
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 1800){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  爆破　準備
    //     if(showBomb){setShowBomb(false)}
    //     //  確定　準備
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 2000){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  爆破　準備
    //     if(showBomb){setShowBomb(false)}
    //     //  確定　準備
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 2200){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  爆破　準備
    //     if(showBomb){setShowBomb(false)}
    //     //  確定　準備
    ...
    //     //  プルプル開始
    //     if(!hurueruHokuto){setHurueruHokuto(true)}
    // }else if(UndercardTickerCurrentTime === 2600){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  爆破　準備
    //     if(showBomb){setShowBomb(false)}
    //     //  確定　準備
    ...
    //     //  プルプル開始
    //     if(!hurueruHokuto){setHurueruHokuto(true)}
    // }else if(UndercardTickerCurrentTime === 2800){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  爆破　準備
    //     if(showBomb){setShowBomb(false)}
    //     //  確定　準備
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 3200){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  ST6なら爆破
    //     if(!showBomb && StepRandResult === 'step6'){setShowBomb(true)}
    //     //  確定　準備
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 3600){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  ST6なら爆破
    //     if(!showBomb && StepRandResult === 'step6'){setShowBomb(true)}
    //     //  ST6なら確定
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 3800){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  ST6なら爆破
    //     if(!showBomb && StepRandResult === 'step6'){setShowBomb(true)}
    //     //  ST6なら確定
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 4000){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  ST6なら爆破
    //     if(!showBomb && StepRandResult === 'step6'){setShowBomb(true)}
    //     //  ST6なら確定
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 4200){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  ST6なら爆破
    //     if(!showBomb && StepRandResult === 'step6'){setShowBomb(true)}
    //     //  ST6なら確定
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 4400){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  ST6なら爆破
    //     if(!showBomb && StepRandResult === 'step6'){setShowBomb(true)}
    //     //  ST6なら確定
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 4600){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  ST6なら爆破
    //     if(!showBomb && StepRandResult === 'step6'){setShowBomb(true)}
    //     //  ST6なら確定
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 4800){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  ST6なら爆破
    //     if(!showBomb && StepRandResult === 'step6'){setShowBomb(true)}
    //     //  ST6なら確定
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 5000){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  ST6なら爆破
    //     if(!showBomb && StepRandResult === 'step6'){setShowBomb(true)}
    //     //  ST6なら確定
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 5200){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  ST6なら爆破
    //     if(!showBomb && StepRandResult === 'step6'){setShowBomb(true)}
    //     //  ST6なら確定
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 5400){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  ST6なら爆破
    //     if(!showBomb && StepRandResult === 'step6'){setShowBomb(true)}
    //     //  ST6なら確定
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 5600){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  ST6なら爆破
    //     if(!showBomb && StepRandResult === 'step6'){setShowBomb(true)}
    //     //  ST6なら確定
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 5800){
    //     if(isAllowDisplay === 'hidden'){setIsAllowDisplay('')}
    //     //  ST6なら爆破
    //     if(!showBomb && StepRandResult === 'step6'){setShowBomb(true)}
    //     //  ST6なら確定
    ...
    //     //  プルプル停止
    //     if(hurueruHokuto){setHurueruHokuto(false)}
    // }else if(UndercardTickerCurrentTime === 6000){
    //     if(isAllowDisplay === ''){setIsAllowDisplay('hidden')}
    //     //  ST6なら爆破
    //     if(!showBomb && StepRandResult === 'step6'){setShowBomb(true)}
    //     //  ST6なら確定
